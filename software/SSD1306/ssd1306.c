...
void ssd1306_WriteCommand(uint8_t byte){
	...
	Start_i2c(I2C1);
	Write_addr_i2c(I2C1, SSD1306_I2C_ADDR, 0);
	Write_one_data_i2c(I2C1, 0x00);
	Write_last_data_i2c(I2C1, byte);
	Stop_i2c(I2C1);
...
void ssd1306_WriteData(uint8_t* buffer, uint16_t buff_size) {
	...
	Start_i2c(I2C1);
	Write_addr_i2c(I2C1, SSD1306_I2C_ADDR, 0);
	Write_one_data_i2c(I2C1, 0x40);
	
	for(i = 0; i < buff_size; i++){
		
		Write_data_i2c(I2C1, buffer[i]);
