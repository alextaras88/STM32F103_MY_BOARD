...
/*********************************************************************************************************/
//void USART_IRQHandler (USART_TypeDef* USARTx){ 										// Обработчик прерывания на приём
//	                  
//	if (USARTx->SR & USART_CR1_RXNEIE){            									// Обрабатываем прерывание тока по приёму
//		
//		USARTx->SR &= ~USART_CR1_RXNEIE; 															// сбрасываем флаг прерывания
//		
//		
//		if (USARTx->DR == '0'){
//			
//			USART_Send_String (USARTx, "OFF\r\n");
