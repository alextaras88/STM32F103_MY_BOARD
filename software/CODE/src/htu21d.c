...
void htu21d_SoftReset(void){
	...
	Start_i2c(I2C2);
	Write_addr_i2c(I2C2, 0x40,0);
	Write_last_data_i2c(I2C2, 0xEF);
	Stop_i2c(I2C2);
...
uint16_t htu21d_ReadValue(uint8_t cmd){
	...
	Start_i2c(I2C2);
	Write_addr_i2c(I2C2, 0x40,0);
	Write_last_data_i2c(I2C2, cmd);
	
	Start_i2c(I2C2);
	Write_addr_i2c(I2C2, 0x40,1);
	msb = Read_data_i2c(I2C2);
  lsb = Read_data_i2c(I2C2);
  checksum = Read_last_data_i2c(I2C2);
